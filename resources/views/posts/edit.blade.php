                            ...
                            <form action="{{ route('posts.update',$post->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="title" type="text" class="form-control" value="{{ old('title',$post->title)}}" placeholder="post title" aria-label="Username" aria-describedby="basic-addon1">
                                    </div>
                                    @error('title')
                                ...
                                <div class="form-group mb-0">
                                    <div class="input-group">
                                        ...
                                        <textarea name="content" class="form-control"  aria-label="With textarea">                                        {{ old('content',$post->content)}}
                                        </textarea>
                                    </div>
                                    @error('content')
                                    <div class="alert alert-warning" role="alert">
